...
const CordinatingSecretary = ({handleSelection, position, size, category}) => {
    ...
    return (
        <>
            {checkIfVoted(category) && (
                <>
                    <h3>You have already voted for Cordinating Secretary.</h3>
...
export default CordinatingSecretary;
